	    ...
	    if($stmt = $mysqli->prepare($sql)){
                ...
                if($stmt->execute()){
                    ...
                    if($stmt->num_rows == 1){                    
                        ...
                        $username_err = 'No existe una cuenta para este usuariooo '.$username.$hashed_password;
                    }
                } else{
                    echo "Oops! Algo falló, prueba otra vez más tarde o habla con el administrador: mahernandezc@educaragon.aragon.es";
                }
            }
...
input[type=text], input[type=password] {
    ...
    <body>
        <div class="wrapper">
            ...
            <p>Introduce tu nombre de  usuario y contraseña (los mismos que en la<a href='http://servicios3.aragon.es' target='blank'> aplicacion de FCTs</a>)<br><i>El sistema ya se ha habilitado para ser usado por alumnos, tutores y directores de centro</i></p>
...
<footer class="page-footer font-small stylish-color-dark pt-4 mt-4">
    ...
    <div class="footer-copyright py-3 text-center">
        ...
        <a href="mailto:mahernandezc@educa.aragon.es">mahernandezc@educa.aragon.es </a>
    </div>
            </li>
        </ul>
    </div>
