...
<button class="btn btn-primary bform" data-toggle="collapse" data-target="#formal" style='float:right'>Anadir alumno</button>
	...
	<input type="text" class="nombre form-control" id="nnombre"  name="" placeholder="Nombre y apellidos" required >
	...
	<input type="text" class="nombre form-control"  id="codciclo" placeholder="codigociclo" required>
