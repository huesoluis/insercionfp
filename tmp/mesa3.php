...
<head>
	...
	<script src="../js/g_global_mesa3.js"></script>
...
<div class="col-sm-2">
 <!-- Sidebar -->
    <nav id="">
<h2 style='text-align:center'> MESA 3<p>Ingenierias y Arquitectura</p></h2>
        <ul class="list-unstyled components">
<h5 style='border: 1px solid black;padding: 16px;text-align: center;'>EDIFICACION Y OBRA CIVIL</h5>
                                    <li> 
...
<h5 style='border: 1px solid black;padding: 16px;text-align: center;'>ELECTRICIDAD Y ELECTRÓNICA</h5>
									<li> i
...
Técnico Superior en Sistemas de Telecomunicaciones e Informáticos
									...
									<li> 
co Superior en Mantenimiento Electrónico 
...
<h5 style='border: 1px solid black;padding: 16px;text-align: center;'>ENERGÍA Y AGUA</h5>
									<li> 
...
<h5 style='border: 1px solid black;padding: 16px;text-align: center;'>FABRICACIÓN MECÁNICA</h5>
									<li>
...
<h5 style='border: 1px solid black;padding: 16px;text-align: center;'>INFORMATICA Y COMUNICACIONES</h5>
									<li> 
...
<h5 style='border: 1px solid black;padding: 16px;text-align: center;'>INSTALACION Y MANTENIMIENTO</h5>
									<li> 
...
Técnico Superior en Mantenimiento de Instalaciones Térmicas y de Fluidos.
									...
									<li> 
co Superior en Desarrollo de Proyectos de Instalaciones Térmicas y de Fluidos.

									</li>
<h5 style='border: 1px solid black;padding: 16px;text-align: center;'>TRANSPORTE Y MANTENIMIENTO DE VEHICULOS</h5>
									<li> 
