...
<div class="container-fluid">
	...
	<h3 style='text-align:center'><?php echo $nombrecentro; ?></h3>
		<?php if($idgrupo=='director'){ ?><p style='text-align:center'><a  id='datacentro' title='Para ver en Excel usar pestaña DATOS, opcion TEXTO EN COLUMNAS' href='<?php echo "../datos_junio19/centros/".$_SESSION["nombrecentro"]."/datos_alumnos_respuestas.csv" ?>' >Descargar datos brutos en csv</a></p><?php }?>
	...
	<div class="panel-group" id="accordion">
		...
		<?php if($idgrupo!='alumno'){ ?><p class="text-center"><a href="#" class="btn btn-primary btn-lg" role="button" data-toggle="modal" data-target="#login-modal_p1">Nuevo alumno <?php echo FECHAFCT1; ?></a></p><?php }?>
				...
				<div class="panel-body">
					...
					<?php 
					echo "<div id='ejun'><button  type='submit' class='btn btn-primary enviarp1' id='p1_grd'>Enviar datos ".FECHAFCT1." </button></div>";
					if($nc1!=0) 
					{
	...
	<div class="panel-group" id="accordion1">
		...
		<?php if($idgrupo!='alumno'){ ?><p class="text-center"><a href="#" class="btn btn-primary btn-lg" role="button" data-toggle="modal" data-target="#login-modal_p2">Nuevo alumno <?php echo FECHAFCT2; ?></a></p><?php }?>
				...
				<div class="panel-body">
					...
					<form lang="es" class="form-inline" action="php/get_datos.php" method='post'>
					<?php 
					echo "<div id='ejunio'><button  type='submit' class='btn btn-primary enviarp2' id='p2_grd'>Enviar datos ".FECHAFCT2."</button></div>";
					if($nc2!=0) 
					{
