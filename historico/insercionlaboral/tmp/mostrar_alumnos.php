...
<button class="btn btn-primary bform" data-toggle="collapse" data-target="#formal" style='float:right'>Nuevo alumno</button>
	...
	<input type="text" class="nombre form-control"  id="dni" name="dni" placeholder="dni" required>
	<?php
#	if($cc!=0){
...
?>
	<button  type="submit" class="btn btn-primary " id="bpr">Añadir </button>
	</div>
</div>
</body>
