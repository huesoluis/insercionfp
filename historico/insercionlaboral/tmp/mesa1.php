...
<div class="col-sm-2">
 <!-- Sidebar -->
    <nav id="">
<h2 style='text-align:center'> MESA 1<p> Artes y Humanidades</p></h2>
        <ul class="list-unstyled components">
<h5 style='border: 1px solid black;padding: 16px;text-align: center;'> ARTES GRAFICAS</h5>
                                    <li> 
Técnico Superior en Diseño y Edición de Publicaciones Impresas  y Multimedia 
									</li>
<h5 style='border: 1px solid black;padding: 16px;text-align: center;'> IMAGEN Y SONIDO</h5>
                                    <li> 
...
<h5 style='border: 1px solid black;padding: 16px;text-align: center;'>MUEBLES, MADERA Y CORCHO</h5>
...
<h5 style='border: 1px solid black;padding: 16px;text-align: center;'>TEXTIL CONFECCION Y PIEL</h5>
									<li> 
