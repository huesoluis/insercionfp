...
$rowdatafile=$_SESSION['url'].'/historico/datos_enero19/globales/datos_alumnos_respuestas.csv';
}
else
$rowdatafile='../datos_enero19/centros/'.$_SESSION["nombrecentro"].'/datos_alumnos_respuestas.csv';
?>
        </ul>
    </nav>
</div>
<div class="col-sm-8 text-center">
	...
	<div class='row'>	
		...
		<div class="dglobal col-sm-2 col-sm-offset-2 a2">ALUMNOS INSCRITOS EN FCTs<div class="dg"></div><div class="dgp"></div></div>
	...
	<br>
	<div class='row'>	
		<div class="dglobal col-sm-4 col-sm-offset-2 a4 ">PORCENTAJE INSERCION LABORAL<p><i>Respecto al total de alumnos que no estudian</i></p><div class="dg"></div><div class="dgp indicador"></div></div>
		<div class="dglobal col-sm-4 a4 last">PORCENTAJE INSERCION LABORAL VINCULADA<p> (En empresas del sector)</p><p><i>Respecto al total de alumnos que trabajan</i></p><div class="dg"></div><div class="dgp indicador"></div></div>
	</div>
...
<form id='tperiodo'>
	<input class='periodo'  type="radio" name="periodo" value="6m" id="6m" checked><span class='periodo'>6 meses</span><br><i class='itext'>Finalizaron FCTs en el periodo Marzo-Junio 2018</i><br>
	<input type="radio" name="periodo" value="12m" id="12m"><span class='periodo'>12 meses</span><br><i class='itext'> Finalizaron FCTs en el perido septiembre-diciembre de 2017</i><br>
</form>
</div>
</div>
</div>
