...
falumnos_dic18='alumnos_dic18_6meses_serrano.csv'
falumnos_jun18='alumnos_jun18_12meses_serrano.csv'
falumnos='alumnos.csv'
...
print("ALUMNOS Cargados: "+str(nualumnos))
