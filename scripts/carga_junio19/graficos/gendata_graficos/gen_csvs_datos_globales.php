...
$dal = new ACCESO('../../../../datos_junio19/globales/'.$periodo);
require('datos_consultas_globales.php');

#DATOS GLOBALES BRUTOS COMPLETOS
$fcompletos='../../../../datos_junio19/globales/datos_alumnos_respuestas.csv';
$dal->gen_brutos($sql_brutos_respuestas,$fcompletos);



#DATOS GLOBALES PERIODO SEPTIEMBRE-DICIEMBRE de 2018
$fglobal='../../../../datos_junio19/globales/'.$periodo.'/datos_global.csv';
