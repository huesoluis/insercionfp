...
$periododir='12m';
$periodo='dic17';
$dirppal='../../../../datos/centros/'.$periododir.'/';
...
( select grado,count(*) as des from respuestas r, alumnos a,ciclos c where c.idciclofct=a.idciclofct and  r.idalumnofct=a.idalumnofct and  r.periodo='".$periodo."' and  trabaja='EN DESEMPLEO' and FCT!='NO' ".$sql_comp." group by grado ) as t2 
LEFT JOIN 
( select grado,count(*) as tra from respuestas r, alumnos a,ciclos c where c.idciclofct=a.idciclofct and  r.idalumnofct=a.idalumnofct and  r.periodo='".$periodo."' and trabaja='TRABAJA' and FCT!='NO' ".$sql_comp." group by grado ) as t3 
...
( select grado,count(*) as tra from respuestas r, alumnos a,ciclos c where c.idciclofct=a.idciclofct and  r.idalumnofct=a.idalumnofct and  r.periodo='".$periodo."' and  trabaja='TRABAJA' and FCT!='NO' ".$sql_comp." group by grado ) as t2 
LEFT JOIN 
( select grado,count(*) as rel from respuestas r, alumnos a,ciclos c where c.idciclofct=a.idciclofct and  r.idalumnofct=a.idalumnofct and  r.periodo='".$periodo."' and trabaja='TRABAJA' and FCT!='NO' and relacionado='SI' ".$sql_comp." group by grado ) as t3 
on t2.grado=t3.grado";
...
#Alumnos que han finalizado FCTs
$sqlcentros_finalizado="SELECT count(*) nafct from respuestas r, alumnos a, centros cen where cen.idcentrofct=a.idcentro and  r.idalumnofct=a.idalumnofct and r.periodo='".$periodo."' and FCT!='NO' and idcentrofct='parametro1'";

$centros_trabaja_desempleo=
"
SELECT t2.grado as 'GRADO', floor(t2.des/(t2.des+t3.tra)*100) as 'DESEMPLEO',floor(t3.tra/(t2.des+t3.tra)*100) as 'TRABAJA' from 
(select grado,count(*) as des from respuestas r, alumnos a,ciclos c,centros cen where cen.idcentrofct=a.idcentro and a.idcentro='parametro1' and c.idciclofct=a.idciclofct and  r.idalumnofct=a.idalumnofct and  r.periodo='".$periodo."' and  trabaja='EN DESEMPLEO' and FCT!='NO' group by grado ) as t2 
RIGHT JOIN 
(select grado,count(*) as tra from respuestas r, alumnos a,ciclos c ,centros cen where cen.idcentrofct=a.idcentro and a.idcentro='parametro1' and c.idciclofct=a.idciclofct and  r.idalumnofct=a.idalumnofct and  r.periodo='".$periodo."' and trabaja='TRABAJA' and FCT!='NO' group by grado ) as t3 
on t2.grado=t3.grado
";
