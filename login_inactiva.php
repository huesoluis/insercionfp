        ...
        if(empty($username_err) && empty($password_err)){
            ...
            if($stmt = $mysqli->prepare($sql)){
                ...
                if($stmt->execute()){
                    ...
                    echo "Oops! Algo falló, prueba otra vez más tarde o habla con el administrador: mahernandezc@educa.aragon.es";
                }
            }
...
input[type=text], input[type=password] {
    ...
    <body>
        <div class="wrapper">
            ...
            <p>Estamos preparando la próxima edición de diciembre de 2019 que permanecerá activa del 11 al 31 de diciembre de 2019</p>
